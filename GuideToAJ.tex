...
\bibliography{AJcitationsed.bib}
...
%%
% Book metadata
\title{Guide to Automated Journalism}
\author{Adreas Graefe}
...
\textcolor{darkblue}{\textbf{\titlefont\fontsize{52}{52}\selectfont
Automated Journalism}}

\vspace{2.9in}
\textcolor{darkblue}{\towknightfont{\fontsize{16}{16}\selectfont \textbf{Andreas Graefe}}}
...
\noindent\textit{This work was funded by the Tow Foundation and the John S. and James L. Knight Foundation. Thanks to interviewees Saim Alkan, Reginald Chua, Lou Ferrara, Tom Kent, and James Kotecki. Thanks also to Peter Brown, Arjen van Dalen, Nick Diakopoulos, Konstantin D{\"o}rr, Mario Haim, Noam Lemelshtrich Latar, and Claire Wardle for providing comments and suggestions.
}\\[0.1cm]
...
\caption\noindent{\textbf{Figure 1: How algorithms generate news}}
\end{centering}
\end{figure}
...
\caption\noindent{\textbf{Figure 2: Effects of automated journalism}}
\end{centering}
\end{figure}
...
\begin{quote}Matt Carlson, ``The Robotic Reporter,'' \textit{Digital Journalism}, 3(2015): 416--431. 
\end{quote}

\noindent\textbf{For evidence on how news consumers perceive the quality of automated news:}

\begin{quote}Andreas Graefe et al., ``Perception of Automated Computer-Generated News: Credibility, Expertise, and Readability,'' 2015. Paper presented at the 11th Dubrovnik Media Days: Artificial Intelligence, Robots, and Media Conference, October 30--31. 
\end{quote}
\noindent\textbf{For guidelines that news organizations should follow when implementing automated journalism:}

\begin{quote}Tom Kent, ``An Ethical Checklist for Robot Journalism,'' Medium, 24 February 2015. Available at \href{https://medium.com/@tjrkent/an-ethical-checklist-for-robot-journalism-1f41dcbd7be2}{https://medium.com/@tjrkent/an-ethical-checklist-for-robot-journalism-1f41dcbd7be2}.   
\end{quote}
